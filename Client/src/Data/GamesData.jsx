...
export const newgamerelase = shuffle([...BingoGames, ...SlotsGames]);
...
export const liveCasino = [
  ...
  .filter((game) => {
    ...
    return type.includes("casinolive") || type.includes("live casino");
  })
...
export const AllData = [...OriginalsGames, ...SlotsGames, ...liveCasino];
...
export const Hotgame = shuffle([...SlotsGames, ...OriginalsGames]);

export const Exclusivegame = shuffle([...liveCasino, ...OriginalsGames]);
